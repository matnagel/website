...
Furthermore, some pages use {link path="https://www.mathjax.org/" text="mathjax"} to depict mathematical symbols, which is hosted on {link path="https://www.cloudflare.com/privacypolicy/" text="cloudflare"}.

= Credits

The picture of the clasp was created with {link path="https://github.com/jemmybutton/fiziko" text="fiziko"}.
