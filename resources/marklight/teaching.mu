...
{picture path="images/clasp.jpg" title="A clasp" size=width:60.0, style=centered}
...
{link path="geotop.html" text="Course page" }
...
} path="images/matrix.jpg" title="A magic matrix" size=height:15.0}
...
H312, Fridays 13:00
} path="images/bulb.jpg" title="A light bulb" size=height:15.0}

= McMaster / Math 731

Introduction to algebraic topology with focus on the fundamental group and homology.

{link path="algtop.html" text="Course page" }
...
} path="images/vectorfield.jpg" title="Flow of a vectorfield" size=height:15.0}
...
{link path="pdf/math381/Homework1.pdf" text="Homework 1" },
{link path="pdf/math381/Homework2.pdf" text="Homework 2" },
{link path="pdf/math381/Homework3.pdf" text="Homework 3" },
{link path="pdf/math381/Homework4.pdf" text="Homework 4" },
{link path="pdf/math381/Homework5.pdf" text="Homework 5" }
